...
import { Tag } from '../common/stateless/Tag';
...
export const TagsPage = React.memo(({ tagCountList }: Props) => {
...
if (process.env.NODE_ENV !== 'production') TagsPage.displayName = 'TagsPage';
